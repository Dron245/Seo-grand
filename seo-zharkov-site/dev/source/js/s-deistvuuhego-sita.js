...
setInterval(function(){
  if(document.activeElement instanceof HTMLIFrameElement && document.activeElement.classList.contains('notice__video')){   
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function popapShowCaseGoogle(src, srcLogo, link, positions) {
    let googleBlock = document.getElementById('modal-case').querySelector('.tabs__element--google');
  ...
  function popapShowCaseYandex(src) {
    let outYandex = document.getElementById('modal-case').querySelector('.tabs__element--yandex').querySelector('.company-case__slide');
...
if(tabsNavigations) {
  tabsNavigations.forEach(item => {
    item.addEventListener ("mouseover",function() {
      const points = item.closest(".tabs").querySelectorAll(".case2__img-link");       
...
if(casesItems) {
  casesItems.forEach(item => {
    item.addEventListener ("mouseover",function() {
      const points = item.closest(".swiper-wrapper").querySelectorAll(".case2__img-link");      
...
$(".back").click(function(){  
  ...
  tabClosest.find(".tab").removeClass("active")
           .eq(--idx)
               .addClass("active");
  ...
  tabClosest.find(".tab2").removeClass("active")
          .eq(--idx2)
              .addClass("active");             
});
