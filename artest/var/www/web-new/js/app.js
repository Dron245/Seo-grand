! function (s) {
    ...
    window.ymapLoaded = function () {
        ...
        load: function () {
            ...
            return s.setAttribute("type", "text/javascript"), s.setAttribute("src", "https://api-maps.yandex.ru/2.1/?lang=ru_RU&onload=ymapLoaded"), (document.getElementsByTagName("head")[0] || document.documentElement).appendChild(s), t.promise
        },
        promise: t.promise,
        isLoaded: i,
        isLoading: a
